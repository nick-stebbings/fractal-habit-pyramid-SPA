(function () {
  ...
  axios$1.defaults.baseURL = host;
  axios$1.defaults.headers.post["Content-Type"] =
    "application/json;charset=utf-8";

  var client = (function () {
    return {
      get_all: function () {
        return axios$1.get("/api/habit_trees");
      },

      create_node: function (parent_node) {
        return axios$1.post("/api/habit_trees/nodes", { parent_id: parent_node });
      },

      show_one_node: function (id) {
        return axios$1.get("/api/habit_trees/nodes/" + id);
      },

      delete_node: function (id) {
        return axios$1.delete("/api/habit_trees/nodes/" + id);
      },
    };
  })();
